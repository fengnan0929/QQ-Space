...
layui.define(['element', 'form','laypage','jquery','laytpl'],function(exports){
  ...
  laypage.render({
    ...
    ,count: 2//JSON.parse(localStorage.getItem('pdata')).age   //数据总数，从服务端得到
    ,theme: '#07A8C5'
  });
  ...
  $('#item-btn').on('click', function(){
    ...
    var view = $('#LAY-msg-tpl').html(),d =  JSON.parse(localStorage.getItem('pdata'))
    // d是模拟从 localstorage 获取的数据
    ,data = {
      username: d.nickname
      ...
      console.log(d.headpic.substring(d.headpic.indexOf('(') + 1, d.headpic.indexOf(")")));
      //模板渲染
